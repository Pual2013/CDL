...
from core.attention import PAM_Module, CAM_Module
...
class attention_net(nn.Module):
    def __init__(self, topN=4):
        ...
        self.pa = PAM_Module(2048)
        self.ca = CAM_Module(2048)
    ...
    def forward(self, x):
        ...
        rpn_feature, attention = self.pa(rpn_feature.detach())
        ...
        # attention = attention.view(batch, 196, 14, 14)
